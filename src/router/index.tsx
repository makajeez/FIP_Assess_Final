...
// ── Root layout: AuthProvider lives HERE inside the React Router tree ─────────
// This guarantees AuthContext is mounted before any route component renders,
// fixing the "useAuth must be used inside <AuthProvider>" error on Vercel.
function RootLayout() {
  return (
    <AuthProvider>
      <Outlet />
...
export const router = createBrowserRouter([
  {
    // Root route renders AuthProvider + Toaster, all other routes are children
    element: <RootLayout />,
    children: [
      // ── Public ────────────────────────────────────────────────────────────
      {
